...
\ex{}{
    \begin{enumerate}
        ...
        \item Let $E = \{0\} \cup \{2^{-n} \mid n \in \NN\} \subseteq \RR$. Then let $\{U_\alpha\}_{\alpha \in A}$ be an open cover.  Pick $\alpha_0 \in A$ such that $0 \in U_{\alpha_0}$. Since $2^{-n} \to 0$ as $n \to \infty$, in fact $U_{\alpha_0}$ contains all but finitely many of the $2^{-n}$ terms. That is, there exists $N$ such that $2^{-n \in U+{\alpha_0}}$ for all $n \geq N$. Now pick a finite subcover of $\{2^{-n} \mid 0 \leq n \leq N\}$ and we're done. $E$ ic ompact, though $E$ is infinite.
    \end{enumerate}
