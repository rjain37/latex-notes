...
\ex{}{$R$ rectangle, $\mathcal L_o^N(\partial R) = 0$.}
...
\begin{proof}
    ...
    Now we can apply the exercise to find some $\ell \in \NN$ such that $R \subseteq \bigcup_{n=1}^\infty S_n$. So by other example,
    \begin{align*}
    ...
    as $\epsilon \to 0$. So, 
    \begin{align*}
        \vol(R) \leq \mathcal L_o^N(R) \leq \vol(R)
    \end{align*}
    and we are done.
...
\begin{enumerate}
    ...
    \begin{proof}
        ...
        and we are done.
    \end{proof}
    \item If $E_n$ is Lebesgue measurable, $n \in \NN$, then $\bigcup E_n$ is Lebesgue measureable. 
    \begin{proof}
...
\begin{proof}
    Assume $\dist(C, K) = 0$. Take $\epsilon = \frac 1n$, find $x_n \in G$, $y_n \in K$ such that $\Vert x_n - y_n \Vert < \frac 1n$. Since $K$  is sequentially compact, $\exists y_{n_k} \to y \in K$. So,
    \begin{align*}
...
\mlenma{}{$U \subseteq \RR^N$ open. Then, $U = \bigcap Q_n$ where $Q_n$ are closed cubes with disjoint interiors. }
\begin{proof}
